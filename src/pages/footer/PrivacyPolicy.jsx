...
const PrivacyPolicy = () => {
  ...
  return (
    <div className="py-8 sm:px-20 md:px-32">
      <div className="font-semibold text-[25px]">Privacy and Policy</div>
      <div className="font-normal text-[13px] my-8">
        ...
        <ul>
          <li>
            <strong>Application </strong>refers to AslCrpto, the software
        ...
        <ul>
          <li>
            ...
            &ldquo;Our&rdquo; in this Agreement) refers to Avtar Informatica
        ...
        <p>&nbsp;</p>
        <ul>
          <li>Countries refers to: India, &nbsp;United States</li>
        </ul>
        <p>&nbsp;</p>
        <ul>
          <li>
        ...
        <ul>
          <li>
            Website refers to AslCrypto, accessible from <a href="http://aslcrypto.com/">&nbsp;</a>
        ...
        <br/>
        <p>
          We are committed to complying with the GDPR. If you are located in the
          European Union, you have the right to access, rectify, or erase your
          personal data. You may also request the restriction of processing or
        ...
        <p>
          ...
          collected, the sources of that information, the business purpose for
        ...
        <br/>
        <p>
          We adhere to the principles outlined in PIPEDA, including obtaining
          your consent for the collection, use, and disclosure of your personal
          information. You have the right to access your information and request
          corrections.
        </p>
        <br/>
        <h3>
          <strong>CalOPPA (California Online Privacy Protection Act):</strong>
        </h3>
        <br/>
        <p>
          We honor Do Not Track signals and provide information on how our app
          responds to Do Not Track signals in our Cookies Policy.
        </p>
        <p>&nbsp;</p>
        <h2>
        ...
        <p>&nbsp;</p>
        <p>By email: support@aslcrypto.com</p>
      </div>
    </div>
  );
};
